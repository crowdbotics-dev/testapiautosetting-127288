...
## Project Structure
    ...
    ├── testapiautosetting_127288  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_127288`
...
2. Clone this repo and `cd testapiautosetting_127288`
